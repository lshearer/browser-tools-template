...
(function() {
  ...
  (function() {
    ...
    // Only add subscriptions after tools have loaded (iframes activated or extension is installed)
    toolsLoader.onLoaded(function(tools) {
      model.subscribe(function() {
        tools.messages.trigger('todos-updated', {
          todos: model.todos
        });
      });

      tools.messages.handleRequest('current-todos', function(data, respond) {
        respond(model.todos);
      });
    });
  }());
